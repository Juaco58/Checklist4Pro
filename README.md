***Checklist 4 Pro* (Mi Compra)** es una aplicación web creada por Joaquín Luis Navarro con HTML y JavaScript, generada con Gemini IA. La aplicación permite a los usuarios gestionar listas de compras interactivas desde teléfonos inteligentes o computadoras a través de un enlace. Se recomienda instalarla o añadirla a la pantalla de inicio desde el menú del navegador.
